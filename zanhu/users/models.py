...
class User(AbstractUser):
    """自定义用户模型"""
    nickname = models.CharField(blank=True, null=True, verbose_name='昵称', max_length=255)
    job_title = models.CharField(blank=True, null=True, verbose_name='职称', max_length=50)
